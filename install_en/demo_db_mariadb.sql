...
CREATE TABLE EMP
(
   EMPNO    INTEGER(4)   NOT NULL     COMMENT 'Employee number',
   ENAME    VARCHAR(10)  DEFAULT NULL COMMENT 'Name',
   JOB      VARCHAR(9)   DEFAULT NULL COMMENT 'Job',
   MGR      INTEGER(4)   DEFAULT NULL COMMENT 'Direct superior',
   HIREDATE DATETIME     DEFAULT NULL COMMENT 'Date of joining the company',
   SAL      DECIMAL(7,2) DEFAULT NULL COMMENT 'Salary',
   COMM     DECIMAL(7,2) DEFAULT NULL COMMENT 'Bonus',
   DEPTNO   INTEGER(2)   DEFAULT NULL COMMENT 'Department number',
   ACCOUNT  LONGTEXT     DEFAULT NULL COMMENT 'Explanation',
   PRIMARY KEY (EMPNO),
...
CREATE TABLE DEPT (
  DEPTNO INTEGER(2)  NOT NULL     COMMENT 'Department number',
...
Insert into EMP
 ...
 Values
   (1111, 'Hong Gildong', 'Manager', 22, STR_TO_DATE('2012-01-02 00:00:00', '%Y-%m-%d %H:%i:%s'), 5555, 10);
Insert into EMP
   (EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, DEPTNO)
 Values
