package gogo.gogora.mydata.emp.web;
...
import gogo.gogora.mydata.cmmn.MydataUserHeader;
import gogo.gogora.mydata.cmmn.tcp.MydataTcpLengthBaseSendUtil;
import gogo.gogora.mydata.emp.service.EmpFileService;
import gogo.gogora.mydata.emp.service.EmpService;
import gogo.gogora.mydata.emp.vo.DeptListVo;
import gogo.gogora.mydata.emp.vo.EmpListVo;
...
public class EmpController {
    ...
    public void login(gogo.gogora.mydata.emp.vo.LoginVo loginVo, HttpServletRequest request) throws Exception {
    ...
    public void loginFrm(gogo.gogora.mydata.emp.vo.LoginVo loginVo, HttpServletRequest request) throws Exception {    
		String id = loginVo.getId();
	...
	public EmpVo tcpSendTest(EmpVo empVo) throws Exception {
		...
		ElResDataVO resVo = MydataTcpLengthBaseSendUtil.sendFld("localhost", 9999, userHeader, eInVo, eOutVo, 10, false, "EUC-KR");
		
		EmpVo resEmpVo = (EmpVo) resVo.getVo();
		MydataUserHeader resUserHeader =(MydataUserHeader) resVo.getUserHeader();
