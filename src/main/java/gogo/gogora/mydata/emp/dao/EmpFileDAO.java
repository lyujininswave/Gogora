...
public class EmpFileDAO extends MydataDefaultAbstractDAO {
    ...
    public int insertEmpFile(EmpVo empVo) throws ElException {    	
        return insert("gogo.gogora.mydata.emp.insertEmpFile", empVo);
    }
    ...
    public int updateEmpFile(EmpVo empVo) throws ElException {
        return update("gogo.gogora.mydata.emp.updateEmpFile", empVo);
    }
    ...
    public int deleteEmpFile(EmpVo empVo) throws ElException {
        return delete("gogo.gogora.mydata.emp.deleteEmpFile", empVo);
    }
    ...
    public EmpVo selectEmpFile(EmpVo empVo) throws ElException {
        return (EmpVo) selectByPk("gogo.gogora.mydata.emp.selectEmpFile", empVo);
    }
