package gogo.gogora.mydata.emp.vo;
...
public class EmpListVo extends gogo.gogora.mydata.cmmn.MydataCommVO {
    ...
    private java.util.List<gogo.gogora.mydata.emp.vo.EmpVo> empVoList;
    ...
    private java.util.List<gogo.gogora.mydata.emp.vo.DeptVo> deptVoList;
    ...
    private gogo.gogora.mydata.emp.vo.EmpVo empVo;

    public int getEmpCnt(){
        return empVoList != null ? empVoList.size() : 0 ;
    }

    public java.util.List<gogo.gogora.mydata.emp.vo.EmpVo> getEmpVoList(){
        return empVoList;
    }

    public void setEmpVoList(java.util.List<gogo.gogora.mydata.emp.vo.EmpVo> empVoList){
        this.empVoList = empVoList;
    }

    public java.util.List<gogo.gogora.mydata.emp.vo.DeptVo> getDeptVoList(){
        return deptVoList;
    }

    public void setDeptVoList(java.util.List<gogo.gogora.mydata.emp.vo.DeptVo> deptVoList){
        this.deptVoList = deptVoList;
    }

    public gogo.gogora.mydata.emp.vo.EmpVo getEmpVo(){
        return empVo;
    }

    public void setEmpVo(gogo.gogora.mydata.emp.vo.EmpVo empVo){
        this.empVo = empVo;
    }
	...
	public byte[] marshalFld(String encode) throws Exception{
        ...
        try {
            ...
            for( int i=0 ; empVoList != null && i < empVoList.size() ; i++ ) {
                gogo.gogora.mydata.emp.vo.EmpVo vo = (gogo.gogora.mydata.emp.vo.EmpVo)empVoList.get(i);
    ...
    public void unMarshalFld( byte[] bytes , String encode) throws Exception{
        try{ 
             ...
             {
                 java.util.List<gogo.gogora.mydata.emp.vo.EmpVo> alList = new java.util.ArrayList<gogo.gogora.mydata.emp.vo.EmpVo>();
                 for( int i=0 ; i < empCnt ; i++ ) {
                     gogo.gogora.mydata.emp.vo.EmpVo vo = new gogo.gogora.mydata.emp.vo.EmpVo(_offset);
    ...
    public void _xStreamEnc() {
        ...
        for( int i=0 ; deptVoList != null && i < deptVoList.size() ; i++ ) {
            gogo.gogora.mydata.emp.vo.DeptVo vo = (gogo.gogora.mydata.emp.vo.DeptVo)deptVoList.get(i);
            vo._xStreamEnc();	 
        }
