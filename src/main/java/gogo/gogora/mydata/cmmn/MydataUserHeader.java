...
public class MydataUserHeader extends com.inswave.elfw.core.UserHeader {
    private static final long serialVersionUID = 1L;

    private int _offset;

    public MydataUserHeader(){
        this._offset = 0;
    }

    public MydataUserHeader(int iOffset){
    ...
    private java.util.List<gogo.gogora.mydata.cmmn.Test01UserHeader> test01UserHeader;
    ...
    private java.util.List<gogo.gogora.mydata.cmmn.Test02UserHeader> test02UserHeader;
    ...
    public java.util.List<gogo.gogora.mydata.cmmn.Test01UserHeader> getTest01UserHeader(){
        return test01UserHeader;
    }

    public void setTest01UserHeader(java.util.List<gogo.gogora.mydata.cmmn.Test01UserHeader> test01UserHeader){
        this.test01UserHeader = test01UserHeader;
    }

    public java.util.List<gogo.gogora.mydata.cmmn.Test02UserHeader> getTest02UserHeader(){
        return test02UserHeader;
    }

    public void setTest02UserHeader(java.util.List<gogo.gogora.mydata.cmmn.Test02UserHeader> test02UserHeader){
    ...
    public void _xStreamEnc() {
        for( int i=0 ; test01UserHeader != null && i < test01UserHeader.size() ; i++ ) {
            gogo.gogora.mydata.cmmn.Test01UserHeader vo = (gogo.gogora.mydata.cmmn.Test01UserHeader)test01UserHeader.get(i);
            vo._xStreamEnc();	 
        }
        for( int i=0 ; test02UserHeader != null && i < test02UserHeader.size() ; i++ ) {
            gogo.gogora.mydata.cmmn.Test02UserHeader vo = (gogo.gogora.mydata.cmmn.Test02UserHeader)test02UserHeader.get(i);
            vo._xStreamEnc();	 
        }
    }
