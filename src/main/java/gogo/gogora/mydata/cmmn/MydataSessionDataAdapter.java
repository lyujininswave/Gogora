...
/**  
 * @Class Name : MydataSessionDataAdapter.java
 ...
 */
public class MydataSessionDataAdapter extends SessionDataAdapter {
	/**
	 * SessionAdapter 생성자이다.
	 * 
	 * @param adapterInfoMap Adapter 정보
	 */
	public MydataSessionDataAdapter(Map<String, Object> adapterInfoMap) {
	 ...
	 * @return MydataUserHeader
	 * @throws AdapterException
	 */
	@Override
	public MydataUserHeader setSessionData(HttpServletRequest request, String id, Object... obj) throws AdapterException{
